                            ...
                            <Card className={`p-6 border-2 ${getRiskBgClass(prediction.risk_level)}`}>
                                ...
                                <div className="space-y-3">
                                    ...
                                    <div className="mt-6 pt-4 border-t border-gray-100">
                                        <h4 className="text-sm font-semibold text-gray-900 mb-3">Input Data Summary</h4>
                                        <div className="grid grid-cols-1 md:grid-cols-3 gap-3">
                                            {/* Geotechnical */}
                                            <div className="p-3 bg-gray-50 rounded text-xs space-y-2">
                                                <h5 className="font-bold text-gray-500 uppercase">Geotechnical</h5>
                                                <div className="flex justify-between"><span>Displacement</span><span className="font-mono">{sensorData.disp_last} mm</span></div>
                                                <div className="flex justify-between"><span>Mean (1h)</span><span className="font-mono">{sensorData.disp_1h_mean} mm</span></div>
                                                <div className="flex justify-between"><span>Std Dev</span><span className="font-mono">{sensorData.disp_1h_std}</span></div>
                                                <div className="flex justify-between"><span>Pore Pressure</span><span className="font-mono">{sensorData.pore_kpa} kPa</span></div>
                                                <div className="flex justify-between"><span>Vibration</span><span className="font-mono">{sensorData.vibration_g} g</span></div>
                                            </div>

                                            {/* Environmental */}
                                            <div className="p-3 bg-blue-50/50 rounded text-xs space-y-2">
                                                <h5 className="font-bold text-blue-500 uppercase">Environmental</h5>
                                                <div className="flex justify-between"><span>Rainfall (1h)</span><span className="font-mono">{sensorData.precip_mm_1h} mm</span></div>
                                                <div className="flex justify-between"><span>Temperature</span><span className="font-mono">{sensorData.temp_c} °C</span></div>
                                            </div>

                                            {/* Geometric */}
                                            <div className="p-3 bg-gray-50 rounded text-xs space-y-2">
                                                <h5 className="font-bold text-gray-500 uppercase">Geometric</h5>
                                                <div className="flex justify-between"><span>Slope Angle</span><span className="font-mono">{sensorData.slope_deg}°</span></div>
                                                <div className="flex justify-between"><span>Aspect</span><span className="font-mono">{sensorData.aspect_deg}°</span></div>
                                                <div className="flex justify-between"><span>Roughness</span><span className="font-mono">{sensorData.roughness}</span></div>
                                                <div className="flex justify-between"><span>Curvature</span><span className="font-mono">{sensorData.curvature}</span></div>
                                            </div>
                                        </div>
                                    </div>
                                </div>
