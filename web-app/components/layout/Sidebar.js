...
const navConfig = {
    ...
    site_admin: [
        { label: 'Dashboard', href: '/dashboard', icon: LayoutDashboard },
        {
            ...
            icon: Users,
            subItems: [
                { label: 'View All', href: '/dashboard/workers' },
                { label: 'Worker Status', href: '/dashboard/workers/status' },
                { label: 'Create Workers', href: '/dashboard/workers/create' },
                { label: 'Invite Worker', href: '/dashboard/workers/invite' },
            ]
        },
        {
            label: 'ML Analytics',
